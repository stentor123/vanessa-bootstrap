...
Процедура ПриОткрытии(Отказ)
	...
	ШаблонПользовательскийСайт = НСтр("ru = 'сайта поддержки пользователей системы ""1C:Предприятие 8""'");
...
Процедура ПослеПроверкиРасширенияРаботыСФайлами(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат Тогда
		Файл = Новый Файл();
		ДополнительныеПараметры.Вставить("СледующееОповещение", Новый ОписаниеОповещения("ОпределениеСуществованияФайла", ЭтаФорма, ДополнительныеПараметры));
		Оповещение = Новый ОписаниеОповещения("ИнициализироватьФайл", ЭтаФорма, ДополнительныеПараметры);
...
Процедура ОпределениеСуществованияФайла(Существует, ДополнительныеПараметры) Экспорт
	...
	Файл = Новый Файл();
	ДополнительныеПараметры.СледующееОповещение = Новый ОписаниеОповещения("ОпределениеСуществованияКаталога", ЭтаФорма, ДополнительныеПараметры);
	Оповещение = Новый ОписаниеОповещения("ИнициализироватьФайл", ЭтаФорма, ДополнительныеПараметры);
