...
Процедура ОткрытьКаталогОбменаИнформациейУзла()
	...
	Оповещение = Новый ОписаниеОповещения("ПослеПроверкиРасширенияРаботыСФайлами", ЭтаФорма, ДополнительныеПараметры);
...
Процедура ПослеПроверкиРасширенияРаботыСФайлами(Результат, ДополнительныеПараметры) Экспорт
	...
	Если Результат Тогда
		...
		Файл = Новый Файл();
		ОписаниеОповещения = Новый ОписаниеОповещения("ПроверитьСуществованиеФайла", ЭтаФорма, ДополнительныеПараметры);
...
Процедура ПослеОпределенияСуществованияФайла(Существует, ДополнительныеПараметры) Экспорт
	...
	Если Существует Тогда
		...
		ОписаниеОповещения = Новый ОписаниеОповещения("ОпределитьЭтоКаталог", ЭтаФорма, ДополнительныеПараметры);
...
Процедура ОпределитьЭтоКаталог(ЭтоКаталог, ДополнительныеПараметры) Экспорт
	...
	Если ЭтоКаталог Тогда
		ОписаниеОповещения = Новый ОписаниеОповещения("ОткрытьКаталогСФайлом", ЭтаФорма, ДополнительныеПараметры);
...
Процедура УдалитьВременныйКаталогСообщенийОбмена(ИмяВременногоКаталога)
	...
	Если Не ПустаяСтрока(ИмяВременногоКаталога) Тогда
		...
		Исключение
			ЗаписьЖурналаРегистрации(НСтр("ru = 'Обмен данными.Удаление временных файлов'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
...
Процедура ПолучениеДанныхЧерезВнешнееСоединениеИлиВебСервис()
	...
	// Загрузка данных
	ТаблицаПереходовНоваяСтрокаДлительнаяОперация(10, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание", Истина, "ЗагрузкаДанных_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрокаДлительнаяОперация(11, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание", Истина, "ЗагрузкаДанныхДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрокаДлительнаяОперация(12, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание", Истина, "ЗагрузкаДанныхДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
...
Процедура ОтправкаДанныхЧерезОбычныеКаналыСвязи()
	...
	// Выгрузка данных
	ТаблицаПереходовНоваяСтрокаДлительнаяОперация(3, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание", Истина, "СтраницаОжиданияВыгрузкиДанных_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрокаДлительнаяОперация(4, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание", Истина, "СтраницаОжиданияВыгрузкиДанныхДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрокаДлительнаяОперация(5, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание", Истина, "СтраницаОжиданияВыгрузкиДанныхДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
...
Процедура ОтправкаДанныхЧерезВнешнееСоединениеИлиВебСервис()
	...
	// Выгрузка данных
	ТаблицаПереходовНоваяСтрокаДлительнаяОперация(4, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание", Истина, "СтраницаОжиданияВыгрузкиДанных_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрокаДлительнаяОперация(5, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание", Истина, "СтраницаОжиданияВыгрузкиДанныхДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрокаДлительнаяОперация(6, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание", Истина, "СтраницаОжиданияВыгрузкиДанныхДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
...
Процедура ПолучениеИОтправкаДанныхЧерезОбычныеКаналыСвязи()
	...
	// Выгрузка данных
	ТаблицаПереходовНоваяСтрокаДлительнаяОперация(13, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание", Истина, "СтраницаОжиданияВыгрузкиДанных_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрокаДлительнаяОперация(14, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание", Истина, "СтраницаОжиданияВыгрузкиДанныхДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрокаДлительнаяОперация(15, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание", Истина, "СтраницаОжиданияВыгрузкиДанныхДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
...
Процедура ПолучениеИОтправкаДанныхЧерезВнешнееСоединениеИлиВебСервис()
	...
	// Выгрузка данных
	ТаблицаПереходовНоваяСтрокаДлительнаяОперация(14, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание", Истина, "СтраницаОжиданияВыгрузкиДанных_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрокаДлительнаяОперация(15, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание", Истина, "СтраницаОжиданияВыгрузкиДанныхДлительнаяОперация_ОбработкаДлительнойОперации");
	ТаблицаПереходовНоваяСтрокаДлительнаяОперация(16, "СтраницаОжиданияСинхронизацииДанных", "СтраницаНавигацииОжидание", Истина, "СтраницаОжиданияВыгрузкиДанныхДлительнаяОперацияОкончание_ОбработкаДлительнойОперации");
